...
class _AllDoctorsViewState extends State<AllDoctorsView> {
  ...
  Widget AllDoctorsWidget (List<DoctorModel> listApp,
      PatientCubit cubit,double price) {
        ...
        child: Container(
          ...
          ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                bool view=true;
                if(listApp[index].date_end.toString().length>2){
                  DateTime currentDate = DateTime.now();
                  String date=listApp[index].date_end!;
                                          ...
                                          children: [
                                            ...
                                            Row(
                                              children: [
                                                ...
                                                Custom_Text(
                                                  text: (double.parse
                                                    (listApp[index].price!)/price).toStringAsFixed(1)+" " +currency,
                                                  color: ColorsManager.primary,
                                                  fontSize: 16,
                                                  alignment: Alignment.center,
                                                ):SizedBox()
