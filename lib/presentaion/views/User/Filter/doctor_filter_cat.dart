...
class FilterCatDoctorView extends StatelessWidget {

  String doctorCat;


  FilterCatDoctorView({required this.doctorCat});
                ...
                body: Container(
                  ...
                  child: ListView(
                    children: [
                      ...
                      AllFiltersWidget(cubit.filterCatList,cubit,doctorCat),
                    ],
                  ),
                ),
              );
      ...
      child: Container(
        ...
        GridView.builder(
          ...
          itemBuilder: (context, index) {
            ...
            if(listApp[index].country==country&&listApp[index].doctor_cat==place2){
